...
const PATHS = {
  ...
  controllersApi: path.resolve(
    __dirname,
    "..",
    "controllers",
    "controllersApi"
  ),
  controllersView: path.resolve(
    __dirname,
    "..",
    "controllers",
    "controllersView"
  ),
  controllersLogin: path.resolve(
    __dirname,
    "..",
    "controllers",
    "controllersLogin"
  ...
  cargaInicialService: path.resolve(
    __dirname,
    "..",
    "service",
    "cargaInicial.js"
  ...
  // STATIC
  staticBienvenidaHtml: path.resolve(
    __dirname,
    "..",
    "static",
    "bienvenida.html"
  ...
  staticProductosHtml: path.resolve(
    __dirname,
    "..",
    "static",
    "productos.html"
  ...
  staticZapatillasHtml: path.resolve(
    __dirname,
    "..",
    "static",
    "zapatillas.html"
  ...
  staticCssBienvenida: path.resolve(
    __dirname,
    "..",
    "static",
    "css",
  ...
  staticCssDashboard: path.resolve(
    __dirname,
    "..",
    "static",
    "css",
  ...
  staticCssModificar: path.resolve(
    __dirname,
    "..",
    "static",
    "css",
  ...
  staticCssProductos: path.resolve(
    __dirname,
    "..",
    "static",
    "css",
